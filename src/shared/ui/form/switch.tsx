	...
	return (
		...
		>
			<SwitchPrimitive.Thumb
				...
				className={cn(
					"dot",
					// "pointer-events-none block aspect-square rounded-full ring-0 shadow-lg ",
					// "transition-transform data-[state=checked]:translate-x-[calc(100%-13px)] data-[state=unchecked]:translate-x-0",
				)}
			/>
		</SwitchPrimitive.Root>
	);
